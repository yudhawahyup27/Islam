<template>
  ...
  >
    <img
      src="https://png.pngtree.com/thumb_back/fh260/background/20210324/pngtree-holy-alquran-background-design-image_590800.jpg"
      alt="Banner "
    ...
    >
      <h1 class="text-white text-xl">Al Quran</h1>
      <h4>
...
<style scoped>
.card {
  background-image: url("/assets/img/alquran-banner.jpg");
